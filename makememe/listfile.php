...
print '<ul class="tabs">
        <li class="tab col m3 s12"><a href="#adsense">Adsense</a></li>
        <li class="tab col m3 s12"><a href="#adwords">Adwords</a></li>
        <li class="tab col m3 s12"><a href="#analytics">Analytics</a></li>
		...
		<li class="tab col m3 s12"><a href="#news">News</a></li>
		<li class="tab col m3 s12"><a href="#playstore">Play Store</a></li>
		<li class="tab col m3 s12"><a href="#webmaster">Webmaster</a></li>
		<li class="tab col m3 s12"><a href="#youtube">You Tube</a></li>	
      </ul>';
...
for($z=0;$z<count($listaserv);$z++){
	...
	for($i=0;$i<count($arrayfile);$i++){
		...
		if($nomefile[0]==$listaserv[$z]){
			print "<div class='col m3 s12 center'>
